      ...
      >
        <Modal.Body>
          <Container>
            <Row>
              ...
              <Col md={6}>
                <h3>
                  Uploaded By: {props.modalData?.user?.name} (@
                  {props.modalData?.user?.id})
                </h3>
        ...
        <Modal.Footer>
          ...
          <Button
            variant="primary"
            style={{
              backgroundColor: props.modalData?.color,
              borderColor: props.modalData?.color
            }}
            href={props.modalData?.links?.download}
            target="_blank"
          >
            Download
          </Button>
